    ...
    <div className="flex items-center justify-center min-h-screen bg-[#fcf9f6] pt-20 pb-10">
      ...
      >
        <div className="text-center mb-10">
          <p className="text-[10px] uppercase tracking-[0.3em] font-semibold mb-3 text-[var(--dark-green)]">Welcome Back</p>
          <h2 className="text-3xl md:text-4xl font-serif-garamond text-gray-900 leading-tight">Access Your Account</h2>
        </div>
        ...
        <form onSubmit={submitHandler} className="flex flex-col gap-6">
          ...
          <div className="flex justify-end mt-[-10px]">
             <Link to="/forgot-password" className="text-[10px] uppercase tracking-widest text-gray-400 hover:text-[var(--dark-green)] transition-colors">Forgot Password?</Link>
          </div>
        ...
        <p className="text-center text-[11px] uppercase tracking-widest text-gray-500">
          Don't have an account? <Link to="/register" className="text-[var(--dark-green)] font-semibold hover:underline">Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
